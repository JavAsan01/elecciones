                    ...
                    <div class="col-xl-3 col-lg-4 col-md-5 col-sm-8">
                        <div class="single-footer-caption mb-50">
                            ...
                            <div class="footer-logo">
                                <a href="index.html"><img src="<?php echo base_url(); ?>/assets/img/logo/CNE.png" width="110px" alt=""></a>
                                <h2 style="color:white">ELECCIONES 2023</h2>
                            </div>
                            <div class="footer-tittle">
                                <div class="footer-pera">
                                    <p class="info1">ECUADOR</p>
                                </div>
                            </div>
                            <div class="footer-number">
                                <h4><span>+593 </span>963 129 283</h4>
                                <p>javasan@gmail.com</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-5 col-sm-8">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                <img src="<?php echo base_url()?>/assets/img/logo/rep_ecuador.png" alt="" width="100%">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-8 col-sm-8">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                <h4>Dirección</h4>
                                <div class="footer-pera">
                                    <p class="info1">Av. 6 de Diciembre N33-122 y Bosmediano
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Desarrollado por <a href="" target="_blank">JavAsan </a> <i class="fa fa-star" aria-hidden="true"></i>
